...
class Debug {
    ...
    public static function var_dump_plain($var, $expLevel, $depth = 0, $done = array())
    {
        ...
        if (is_bool($var)) {
            ...
            $html .= '<span style="color:#588bff;">int</span><span style="color:#999;">(</span><span style="font-size:15px;color:green;">' . $var . '</span><span style="color:#999;">)</span>';
        } elseif (is_float($var)) {
            $html .= '<span style="color:#588bff;">float</span><span style="color:#999;">(</span><span style="font-size:15px;color:green;">' . $var . '</span><span style="color:#999;">)</span>';
        } elseif (is_string($var)) {
            $html .= '<span style="color:#588bff;">string</span><span style="color:#999;">(</span>' . strlen($var) . '<span style="color:#999;">)</span> <span style="font-size:15px;color:#cc0000;">\'' . self::htmlentities($var) . '\'</span>';
        } elseif (is_null($var)) {
